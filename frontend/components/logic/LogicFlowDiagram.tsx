    ...
    >
      ...
      <div className="relative z-[1] flex h-full flex-col gap-2">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-1 line-clamp-2 text-[11px] leading-snug text-[var(--ar-muted)] font-ui">
            {blurb}
          </p>
        </div>
        {chip ? (
  ...
  return (
    ...
    >
      ...
      <div className="relative z-[2] flex h-full flex-col">
        ...
        <p className="mt-auto pt-2.5 line-clamp-2 text-xs leading-snug text-[var(--ar-muted)] font-ui">
          {module.purpose}
        </p>
      </div>
    </button>
