    ...
    nodes: [
      {
        ...
        kind: "input",
        description:
          "Sample Input or an uploaded .xlsx becomes the live product definition for the desk. Upload and Sample Input both land on current_product.xlsx; every Run re-parses that file.",
        detail:
      ...
      },
      {
        ...
        kind: "lookup",
        description:
          "Label rows for Principal and Tenure Days supply notional and calendar tenure. Principal is INR; Tenure Days set Product End via path_end_calendar.",
        detail:
      ...
      },
      {
        ...
        kind: "process",
        description:
          "Month offsets under the Observation header, deduplicated in file order. Band 1…7; sample 38…56; each maps as start + m × 30.5 to a monthly expiry.",
        detail:
      ...
      },
      {
        ...
        kind: "engine",
        description:
          "Each options-book row becomes an OptionLegSpec; active_legs feed build_legs, which expands every strike × n_obs observation expiries. Header map matches the Backtester book; Include=No rows stay display-only.",
        detail:
      ...
      },
      {
        ...
        kind: "output",
        description:
          "ProductSpec dataclass feeds paths, hedge_path, nav, and desk exports. It is the single Run source of truth for principal, tenure, legs, and path count.",
        detail:
