      ...
      {open ? (
        ...
        >
          <motion.div
            ...
            className="relative mx-4 w-full max-w-lg overflow-hidden rounded-2xl border border-[rgba(212,178,76,0.35)] bg-[var(--ar-surface)] shadow-2xl"
          >
            <div className="h-1.5 w-full bg-gradient-to-r from-[var(--ar-maroon)] via-[var(--ar-gold)] to-[var(--ar-maroon)]" />
            <div className="px-6 py-5">
              <p className="text-[10px] uppercase tracking-[0.22em] text-[var(--ar-subtle)] font-ui">
                Live Simulation
              </p>
              ...
              {!failed ? (
                <>
                  ...
                  <div className="mt-2 flex items-center justify-between text-sm font-ui">
                    ...
                    <span className="font-semibold tabular-nums text-[var(--ar-maroon)]">
                      {pct.toFixed(1)}%
                    </span>
                  </div>
                </>
